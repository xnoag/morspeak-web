    ...
    <>
      <div style={{ background: '#fff', fontFamily: font }}>
        ...
        >
          ...
          {/* 왼쪽 상단 텍스트 */}
          <div style={{ position: 'absolute', top: '8%', left: '4%', pointerEvents: 'none' }}>
            <p style={{ fontSize: 17, fontWeight: 700, color: '#1d1d1f', marginBottom: 10, letterSpacing: '-0.01em' }}>모스픽</p>
            <p style={{ fontSize: 19, fontWeight: 400, color: '#1d1d1f', lineHeight: 1.6, letterSpacing: '-0.02em', whiteSpace: 'pre-line' }}>
              {'눈 깜빡임 하나로,\n당신의 하루가 다시 움직입니다.'}
            </p>
          </div>
          ...
          <div style={{ position: 'absolute', top: '42%', right: '4%', textAlign: 'left', maxWidth: 280, pointerEvents: 'none' }}>
            <p style={{ fontSize: 17, fontWeight: 700, color: '#1d1d1f', marginBottom: 8, letterSpacing: '-0.02em' }}>하나씩, 다시 일상으로</p>
            <p style={{ fontSize: 16, fontWeight: 400, color: 'rgba(0,0,0,0.55)', lineHeight: 1.65, letterSpacing: '-0.01em' }}>
